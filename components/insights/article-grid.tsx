  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      {articles.map((article) => (
        <article
          className="flex min-h-[320px] flex-col justify-between rounded-md border border-ink/10 bg-white p-6 transition hover:-translate-y-1 hover:border-electric/40 hover:shadow-quiet"
          key={article.slug}
